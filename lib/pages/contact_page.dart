...
class ContactPage extends StatelessWidget {
  final List contactItems = [
    ...
    ContactInfo(Icons.phone, 'Phone', '09602723578', Colors.green),
    ContactInfo(Icons.location_on, 'Physical Address', '454 GRC BLDG. Rizal Ave. Cor. 9th ave. East Grace Park, Caloocan City 1400 Metro Manila.', Colors.blue),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 20),
                    Text('MOBILE & EMAIL DIRECTORY', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.black87)),
                    SizedBox(height: 10),
